...
def extract_vesicles(raw_file, seg_file, correction_file, apply_closing=True):
...
def process_33K_L1(output_root):
    ...
    extract_vesicles(raw_file, seg_file, correction_file)
...
def process_64K_LAM12(output_root):
    ...
    extract_vesicles(raw_file, seg_file, correction_file, apply_closing=False)
